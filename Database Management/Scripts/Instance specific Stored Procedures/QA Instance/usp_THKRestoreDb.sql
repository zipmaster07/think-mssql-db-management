...
BEGIN TRY
	...
	*/
	BEGIN
		...
		EXEC sp_executesql @sql, N'@cleanThkVersionIN nvarchar(20) OUTPUT', @thkVersionOUT OUTPUT; --Finds the THINK version of the restored database and converts it to a numeric value
...
GRANT EXECUTE ON [dbo].[usp_THKRestoreDB] TO [MPLS\jdennison];
GO
*/
