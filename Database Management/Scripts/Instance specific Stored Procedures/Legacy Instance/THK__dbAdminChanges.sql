...
SET @printMessage = 'Setting up dbAdmin database for legacy instance:' + char(13) + char(10);
	...
	*/
	BEGIN TRAN insertStmts
		...
		BEGIN TRY
			...
			INSERT INTO params (p_key, p_value)
				VALUES ('DefaultBackupDirectory', 'U:\MSSQL9.LEGACY\MSSQL\Backup');
		...
		BEGIN TRY
			...
			INSERT INTO params (p_key, p_value)
				VALUES ('DefaultDataDirectory', 'R:\MSSQL9.LEGACY\MSSQL\Data\');
		...
		BEGIN TRY
			...
			INSERT INTO params (p_key, p_value)
				VALUES ('DefaultLogDirectory', 'S:\MSSQL9.LEGACY\MSSQL\Logs\');
		...
		SET @printMessage = 'Done inserting into baseline_versions' + char(13) + char(10) + char(13) + char(10) + 'dbAdmin database is now setup for the legacy instance'
		RAISERROR(@printMessage, 10, 1) WITH NOWAIT;
	COMMIT TRAN;
END TRY
BEGIN CATCH
