...
IF EXISTS (SELECT 1 FROM sys.procedures WHERE name = 'tst_THKRestoreDB')
	DROP PROCEDURE [dbo].[tst_THKRestoreDB];
GO

CREATE PROCEDURE [dbo].[tst_THKRestoreDB](
...
GRANT EXECUTE ON [dbo].[tst_THKRestoreDB] TO [MPLS\jschaeffer]
GO
