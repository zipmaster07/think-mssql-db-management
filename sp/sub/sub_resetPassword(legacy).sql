...
DECLARE @userRightsId						int				--dbo.right_desc.right_desc_id for the User Accounts module.
		...
		,@userExists						bit				--Used to indicate if the user exists in the database: 0 = Does not exist, 1 = Does exist.
		,@hasRights							bit				--Used to indicate if the user has rights to the User Accounts module: 0 = Does not have access, 1 = Has access.
